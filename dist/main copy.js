...
// for puase button 
let isPaused = false; // << moved to gamestate control
...
document.getElementById('start-button').addEventListener('click', () => {
    ...
    // Enable pause button when race starts
...
function populateLeaderboard() {
    ...
    cars.forEach((car) => {
        // creates a div element called item then adds the class name leaderboard-item.
        const item = document.createElement('div');
        item.className = 'leaderboard-item';
        // creates a div element called item then adds the class name leaderboard-color, sets the color
        const colorBox = document.createElement('div');
        colorBox.className = 'leaderboard-color';
        colorBox.style.backgroundColor = car.color;
        // creates a div element called item then adds the class name leaderboard-text, sets the text content
